      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <button className="p-4 border-2 border-dashed border-gray-300 rounded-lg hover:border-blue-500 hover:bg-blue-50 transition-all">
            ...
            <p className="text-sm font-medium text-gray-700">Create Client</p>
          </button>
      ...
      {clients.length === 0 && (
        <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-6">
          ...
          <p className="text-blue-800 mb-4">
            Welcome to PIWI! To get started, create your first client folder and upload documents for AI processing.
          </p>
